...
* link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/latest/html/using_automation_execution/controller-execution-environments[Execution Environments^, window=_blank] -- container images that can be utilized as Ansible execution.
...
By default you should be in the `network-workshop` directory in the VS Code terminal.
...
Press the **Esc** key to go up a level, or you can zoom in to an individual host. To exit Ansible Navigator all together simply type `q:` or `ctrl-Z`.
