...
TIP: For the best experience (especially copy/paste in the terminal), open VS Code in its own browser tab instead of using the embedded Showroom frame. Click the **VS Code** tab in Showroom, then right-click and copy the URL, or navigate directly to `https://vscode-{guid}.{domain}/`
...
[control]
ansible ansible_host=13.58.149.157 ansible_user=rhel private_ip=172.16.240.184
----
