...
=== Phase 1: Command-line automation (Modules 1--4)

Build foundational Ansible skills on the command line:

* **Module 1** -- Explore the lab environment, tools, and inventory
* **Module 2** -- Execute your first network automation playbook
* **Module 3** -- Gather and use Ansible facts from network devices
* **Module 4** -- Use network resource modules for multi-vendor configuration

=== Phase 2: Automation Platform (Modules 5--9)

Move to the Ansible Automation Platform web interface:

* **Module 5** -- Explore the Automation controller: inventories, credentials, and projects
* **Module 6** -- Create a job template for network configuration backup
* **Module 7** -- Add surveys for user-friendly input to job templates
* **Module 8** -- Configure RBAC for multi-user access control
* **Module 9** -- Build automation workflows with conditional execution and failure handling
