...
* Examine the remaining routers (`rtr2.txt`, `rtr3.txt`, `rtr4.txt`). This lab includes multiple vendors (Cisco, Arista, and Juniper). Ansible Playbooks can be written to be vendor agnostic -- in this case we provided the Ansible Playbook via the GitHub repo: link:https://github.com/rhpds/summit-2026-network-automation-toolkit[https://github.com/rhpds/summit-2026-network-automation-toolkit^]
