...
* In the AAP web UI, and click on the `Templates` link on the left menu under the Automation Execution section.
+
...
+
image::controller_extra_vars.png[Extra variables,align="center",link=self,window=blank,width=600]
